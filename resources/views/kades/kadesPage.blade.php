	...
	<script type="text/javascript">
		...
		function makeMarker(laporan) {
			...
			for (var i = 0; i < laporan.length; i++) {
				...
				var popup = new mapboxgl.Popup({ offset: 25 }).setHTML('<p><a href="/kades/{{$us->id}}/laporan/'+laporan[i].id+'" class="pop">'+laporan[i].judul+'</a></p> <p class="pop">'+laporan[i].created_at+'<br>'+laporan[i].status+'</p>');
