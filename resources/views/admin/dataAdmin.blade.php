...
@section('isi1')
	<div class="nav">
		<p style="font-size: 14px;"><h3 style="text-align: left;">Data Pengguna > Admin</h3></p>
	            ...
	            <tbody id="body-tab">
		            ...
		            foreach ($list as $key): ?>
		            	<?php  $no = $no + 1; ?>
				            <tr>
				            	<td><?php echo $no ?></td>
				            	<td><a href="/admin/{{$ad->id}}/data/admin/{{$key->id}}" style="text-decoration: none;">{{$key->nama}}</a></td>
