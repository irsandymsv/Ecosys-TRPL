...
@section('isi1')
	<div class="nav">
		<p style="font-size: 14px;"><h3 style="text-align: left;">Data Pengguna > Perangkat Desa</h3></p>
	            ...
	            <tbody id="body-tab">
		            ...
		            foreach ($list as $key): ?>
		            	<?php  $no = $no + 1; ?>
				            <tr>
				            	<td><?php echo $no ?></td>
				            	<td><a href="/admin/{{$ad->id}}/data/perdes/{{$key->id}}" style="text-decoration: none;">{{$key->nama}}</a></td>
...
@section('script')
	...
	<!-- <script type="text/javascript">
		 $(function() {
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ url('admin/{id}/data/tablePerdes') }}',
               columns: [
                        { data: 'id', name: 'id' },
                        { data: 'nama', name: 'nama' },
